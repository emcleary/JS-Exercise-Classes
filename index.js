...
// testing...
const me = new Person('M. It','42')
console.log(me.toString());
for (let i = 0 ; i < 42; i++) {
    me.eat('Soylent');
}
console.log(me.stomach.length);
me.poop();
console.log(me.stomach.length);
...
const someone = new Lambdasian({
    name: 'Name',
    age: 2,
    location: 'Atlantis',
});
console.log(someone.speak())
...
console.log(Brit.demo('Monads'));
console.log(Brit.grade(me, 'Monads'));
...
console.log(someStudent.listSubjects());
console.log(someStudent.PRAssignment('Functional Programming'));
console.log(someStudent.sprintChallenge('Functional Programming'));
...
class ProjectManager extends Instructor {
	...
	return `${this.name} debugs ${student.name}\'s code on ${this.subject} to include ${subject}`;
    }    
}
